...
export default function Gin() {
    ...
    const currentPosts = gin.slice(indexOfFirstPost, indexOfLastPost);
        ...
        <>
            ...
            {!currentPosts ? (<Loading />) : (
                ...
                <section className="py-14 flex flex-col items-center">
                    <h1 className="heading text-center pb-16 ">Coctails with GIN</h1>
                    <Search />
                    <Pagination postsPerPage={postsPerPage} totalPosts={gin.length} paginate={paginate} currentPage={currentPage} />
