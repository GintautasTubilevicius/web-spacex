...
export default function Coctails() {
    ...
    const [noAlco, setNoAlco] = useState([]);
    ...
    const currentPosts = noAlco.slice(indexOfFirstPost, indexOfLastPost);
        ...
        <>
            {!currentPosts ? (<Loading />) : (
                <section className="py-14 flex flex-col items-center">
                    <h1 className="heading text-center pb-16 ">Non Alcoholic Drinks</h1>
                    <Search  />
                    <Pagination postsPerPage={postsPerPage} totalPosts={noAlco.length} paginate={paginate} currentPage={currentPage} />
